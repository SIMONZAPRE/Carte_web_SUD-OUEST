...
lyr_SUDOUEST_1.set('fieldLabels', {'OBJECTID': 'no label', 'Nom': 'inline label - always visible', 'SHAPE_Leng': 'no label', 'SHAPE_Area': 'no label', 'numero': 'no label', 'Superficie': 'inline label - always visible', });
...
lyr_secteur_dactivit_3.set('fieldLabels', {'OBJECTID': 'no label', 'Nom': 'inline label - always visible', 'Code': 'inline label - always visible', 'secteur': 'inline label - always visible', });
